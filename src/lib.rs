// src/lib.rs
/*
 * Core library for CurrencyCodeMapper
 */
...
#[derive(Debug)]
pub struct CurrencyCodeMapperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CurrencyCodeMapperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CurrencyCodeMapper processing");
    
    let mut processor = CurrencyCodeMapperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CurrencyCodeMapperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CurrencyCodeMapperProcessor::new(false);
